...
$automationIntentText = Read-RepositoryFile "ClassIsland.iOS.Native/Extension/ClassIslandAutomationIntent.swift"
...
Assert-True (-not $automationIntentText.Contains('openAppWhenRun')) "An intent compiled into an app extension must not use openAppWhenRun."
